...
## ⏱ 대표 프로젝트 ⏱
  |기간|활동명|설명|기술|역할|
  |:---:|:---:|:---:|:---:|:---:|
  |2023.04 - 2023.12|[`PHOTOCATE`](https://github.com/Yongsoojin/capstone/tree/hyein)|이미지 처리 기술과<br/> 메타데이터를 이용한<br/> 사진편집 & 사진분류 웹사이트|React|페이지 제작 - 홈,로그인,사진분류,사진편집,이미지업로드|
